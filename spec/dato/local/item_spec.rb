      ...
      describe '#autogenerated_slug' do
        ...
        context 'non singleton, no title field' do
          ...
          it 'returns the ID' do
            expect(item.autogenerated_slug).to eq '14'
          end
        end

        context 'non singleton, title field' do
          it 'returns the ID + title' do
            expect(item.autogenerated_slug).to eq '14-my-title-with-accents'
          end
        end

        context 'non singleton, title field, without prefix' do
          it 'returns the title' do
            expect(item.autogenerated_slug(prefix_with_id: false)).to eq 'my-title-with-accents'
          end
        end
      end
